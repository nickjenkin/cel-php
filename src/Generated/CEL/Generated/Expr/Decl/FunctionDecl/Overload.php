...
namespace CEL\Generated\Expr\Decl\FunctionDecl;
 ...
 *
 * Generated from protobuf message <code>cel.expr.Decl.FunctionDecl.Overload</code>
 */
class Overload extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .cel.expr.Type params = 2 [json_name = "params"];</code>
     */
    private $params;
    /**
     ...
     *
     * Generated from protobuf field <code>.cel.expr.Type result_type = 4 [json_name = "resultType"];</code>
     */
     ...
     *           This will be used by a [Reference][cel.expr.Reference] to
     *           indicate the `overload_id` that was resolved for the function `name`.
     *     @type \CEL\Generated\Expr\Type[] $params
     *           List of function parameter [Type][cel.expr.Type] values.
     *           Param types are disjoint after generic type parameters have been
     *           replaced with the type `DYN`. Since the `DYN` type is compatible with
     *           any other type, this means that if `A` is a type parameter, the
     ...
     * @return $this
     */
    public function setOverloadId(string $var)
    {
     ...
     * @return $this
     */
    public function setIsInstanceFunction(bool $var)
    {
